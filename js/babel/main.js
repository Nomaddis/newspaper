...
var checkJsonParse = function checkJsonParse(jsonString) {
...
var check1 = checkJsonParse('{"name":"Jun","color":"red"}').then(function (value) {
    console.log('value', value);
    document.querySelector('#content1').innerHTML = value.name;
